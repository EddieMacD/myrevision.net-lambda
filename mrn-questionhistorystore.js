...
async function decodeUserData(params) {
    ...
    userData.timeSpent = parseInt(params.timeSpent);
...
async function writeQuestionHistoryNoAssignment(userData) {
    ...
    var sqlParams = {
        secretArn: 'arn:aws:secretsmanager:eu-west-2:293120934689:secret:rds-db-credentials/cluster-V4YUHCBNOQZWAQNYBYOORBOKP4/admin-hQLZYp',
        resourceArn: 'arn:aws:rds:eu-west-2:293120934689:cluster:mrn-database-cluster',
        sql: 'INSERT INTO question_history (user_answer_json, timestamp, time_spent, question_id, user_id) VALUES (' + userData.userAnswersJSON
            + ', "' + userData.timestamp + '", ' + userData.timeSpent + ', ' + userData.questionID + ', ' + userData.userID + ');',
        database: 'mrn_database',
        includeResultMetadata: false
    };
...
async function writeQuestionHistoryAssignment(userData) {
    ...
    var sqlParams = {
        secretArn: 'arn:aws:secretsmanager:eu-west-2:293120934689:secret:rds-db-credentials/cluster-V4YUHCBNOQZWAQNYBYOORBOKP4/admin-hQLZYp',
        resourceArn: 'arn:aws:rds:eu-west-2:293120934689:cluster:mrn-database-cluster',
        sql: 'INSERT INTO question_history (user_answer_json, timestamp, time_spent, question_id, user_id, assignment_id) VALUES (' + userData.userAnswersJSON
            + ', "' + userData.timestamp + '", ' + userData.timeSpent + ', ' + userData.questionID + ', ' + userData.userID + ', ' + userData.assignmentID + ');',
        database: 'mrn_database',
        includeResultMetadata: false
    };
